...
@section('content_header')
    ...
    <h1>Detalhes do {{ $plan->name }} <a href="{{ route('details.plan.create', $plan->url) }}" class="btn btn-dark">ADD <i class="fas fa-plus-square"></i></a></h1>
@stop
                    ...
                    @foreach ($details as $detail)
                        <tr>
                            ...
                            <td style="width=10px">
                                ...
                                <!-- <a href="{{ route('plans.edit', $plan->url) }}" class="btn btn-info"><i class="fas fa-trash-alt"></i></a> -->
                            </td>
                        </tr>
